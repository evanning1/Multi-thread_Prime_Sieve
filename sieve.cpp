...
const long long int groupsize = 60000; 
const long long int arrsize = 10000; 
const long long int firstsize = 300; //approx sqrt of groupsize
bool arr1 [arrsize];
bool arr5 [arrsize];
...
void primesieve(long long int threads, long long int lim){
    ...
    for(int ppp = 0; ppp<(lim/groupsize); ppp++){
        memset(arr1, false, arrsize);
        memset(arr5, false, arrsize);
        long long int upper = ppp*lim/groupsize;
        long long int temp = ceil(sqrt(upper));
